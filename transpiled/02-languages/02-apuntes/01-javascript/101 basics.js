...
var a = 3;
var a = 14; // Error! La variable `a` ya ha sido redeclarada
...
// una operación, etc.
var person = "Edward";
var message = "How are you, ".concat(person, "?");
...
console.log(Math.pow(2, 3)); // 8 (Exponenciación)
// [copy-paste version]
console.log(52 + 21);
...
for (var i_2 = 0, limit_1 = 10; i_2 < limit_1; i_2++) {
    console.log(i_2);
}
// bucle "while"
var limit = 10;
