...
var toObject = function (name, surname, age) {
...
var toObject = function (name, surname, age) { return ({ name: name, surname: surname, age: age }); };
...
saySomething("HeLlO wOrLd", function (str) { return str.toLowerCase(); }); // hello world
saySomething("hello  world", function (str) { return str.replace(/[aeiou]/gi, ""); }); // hll wrld
...
// definida.
var g = function () { return console.log(_this.surname); };
...
var sum = function () {
    return Array.from(arguments).reduce(function (acc, val) { return acc + val; });
};
