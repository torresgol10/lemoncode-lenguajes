...
Person.prototype.sayDelayedAge = function () {
    var _this = this;
    setTimeout(function () { return console.log(_this.age); }, 1000);
};
...
var dan = new Person("Dan"); // Uncaught TypeError: Person is not a constructor
