...
var person = { name: name, 43: true, "3dots": true };
...
// 2. for(...)
for (var i_1 = 0; i_1 < collection.length; i_1++) {
    console.log(collection[i_1]); // "hey", "ho", "let's go", "yay", (x95) undefined, "oops!"
}
...
for (var _a = 0, _b = "javi"; _a < _b.length; _a++) {
    var char = _b[_a];
